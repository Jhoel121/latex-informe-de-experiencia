...
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_16.png}
\end{center}
...
\label{fig:resumen_pruebas}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_17.png}
\end{center}
\textit{Nota.} Gráfico de barras que muestra la distribución de las 48 pruebas automatizadas ejecutadas (30 unitarias, 12 de integración y 6 de aceptación), con una tasa de éxito del 100 por ciento en todas ellas.
\end{figure}
...
\label{fig:flujo_errores}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_18.png}
\end{center}
\textit{Nota.} Diagrama de flujo que ilustra el proceso seguido para cada incidencia.
\end{figure}
...
\label{fig:comparativa_fcp}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_19.png}
\end{center}
\textit{Nota.} Gráfico comparativo que muestra la reducción del FCP de 3.8 segundos a 1.1 segundos.
\end{figure}
...
\label{fig:arquitectura_indexacion}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_20.png}
\end{center}
\textit{Nota.} Diagrama que ilustra el flujo con asyncpg e índices B-Tree.
\end{figure}

\begin{figure}[hbt!]
\caption{Comparativa de throughput del servidor antes y después de la optimización}
\label{fig:comparativa_throughput}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_21.png}
\end{center}
\textit{Nota.} Gráfico de barras que compara el throughput del servidor.
\end{figure}
...
\label{fig:evidencia_uat}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_22.png}
\end{center}
\textit{Nota.} Registra el momento de la ejecución de las pruebas con usuarios operando el sistema.
\end{figure}
...
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_23.png}
\end{center}
\textit{Nota.} Ilustra la disposición en capas del sistema: el frontend en Angular 18 con sus tres módulos por rol, el backend en FastAPI con los routers, la capa de servicios y el ORM asíncrono, y la base de datos PostgreSQL 16 con sus índices B-Tree.
\end{figure}
...
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_24.png}
\end{center}
\textit{Nota.} Ilustra la disposición de los servicios en producción y local.
\end{figure}
...
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_25.png}
\end{center}
\textit{Nota.} Ilustra la secuencia desde GitHub hasta producción automática.
\end{figure}
...
\label{fig:diagrama_puesta_marcha}
\begin{center}
\includegraphics[width=\textwidth,height=8cm,keepaspectratio]{IMAGENES/figuras/figura_26.png}
\end{center}
\textit{Nota.} Ilustra la secuencia cronológica de puesta en marcha.
\end{figure}
