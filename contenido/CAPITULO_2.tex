...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Representa los tres niveles de la pirámide de pruebas —pruebas unitarias en la base, pruebas de integración en el nivel intermedio y pruebas de aceptación (UAT) en la cúspide— aplicados sobre los módulos billing.py, security.py, schemas.py, la API REST, SQLAlchemy, PostgreSQL y WebSockets.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Gráfico de barras que muestra la distribución de las 48 pruebas automatizadas ejecutadas (30 unitarias, 12 de integración y 6 de aceptación), con una tasa de éxito del 100 por ciento en todas ellas.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Diagrama de flujo que ilustra el proceso seguido para cada incidencia.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Gráfico comparativo que muestra la reducción del FCP de 3.8 segundos a 1.1 segundos.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Diagrama que ilustra el flujo con asyncpg e índices B-Tree.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Gráfico de barras que compara el throughput del servidor.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Registra el momento de la ejecución de las pruebas con usuarios operando el sistema.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Ilustra la disposición en capas del sistema: el frontend en Angular 18 con sus tres módulos por rol, el backend en FastAPI con los routers, la capa de servicios y el ORM asíncrono, y la base de datos PostgreSQL 16 con sus índices B-Tree.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Ilustra la disposición de los servicios en producción y local.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Ilustra la secuencia desde GitHub hasta producción automática.
\end{figure}
...
\vspace{0.2cm}
\par\noindent\textit{Nota.} Ilustra la secuencia cronológica de puesta en marcha.
\end{figure}
