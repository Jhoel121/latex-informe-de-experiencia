...
\begin{center}
\textit{[Espacio reservado para la Figura 16: Pirámide de pruebas]}
\end{center}
\vspace{2cm}
...
\begin{tabular}{@{}p{2.5cm} p{2cm} p{1.5cm} p{3.5cm} p{3.5cm} p{3cm}@{}}
\toprule
...
\begin{tabular}{@{}p{3.5cm} p{1.5cm} p{2cm} p{3cm} p{3cm} p{2.5cm}@{}}
\toprule
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 17]}
\end{center}
\vspace{2cm}
...
\begin{tabular}{@{}p{1cm} p{2cm} p{4cm} p{1.5cm} p{3cm} p{3.5cm}@{}}
\toprule
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 18]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 19]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 20]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 21]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 22]}
\end{center}
\vspace{2cm}
...
\begin{tabular}{@{}p{0.5cm} p{4.5cm} p{4.5cm} p{1.5cm} p{4cm}@{}}
\toprule
...
\begin{tabular}{@{}p{0.5cm} p{4cm} p{4cm} p{1.5cm} p{4.5cm}@{}}
\toprule
\textbf{N.°} & \textbf{Tarea} & \textbf{Criterio de éxito} & \textbf{Result.} & \textbf{Observaciones} \\
\midrule
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 23]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 24]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 25]}
\end{center}
\vspace{2cm}
...
\vspace{2cm}
\begin{center}
\textit{[Espacio reservado para la Figura 26]}
\end{center}
\vspace{2cm}
